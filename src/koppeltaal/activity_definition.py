...
def parse(xml):
    ...
    for entry in feed.entries:
        ...
        # the future.
        node = entry.content.find('fhir:Other', namespaces=koppeltaal.NS)

        # Make 'useful' attributes accessible here. XXX should use
        # extension URL for getting the correct identifier.
